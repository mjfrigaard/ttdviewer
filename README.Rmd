...
1. The data are loaded directly from GitHub (i.e., this package does not use the [`tidytuesdayR`](https://dslc-io.github.io/tidytuesdayR/) or [`ttmeta`](https://r4ds.github.io/ttmeta/) packages). 
