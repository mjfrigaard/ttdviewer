...
This report provides an overview of the **`r params$tt_title`** dataset from TidyTuesday. The analysis includes data exploration visualizations and a preview of the dataset structure.
...
**Report Generated:** `r Sys.time()`  
**TidyTuesday Dataset:** `r params$tt_title`  
