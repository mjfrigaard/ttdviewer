...
edge cases and examples. Runs
[`clean_title_string()`](https://mjfrigaard.github.io/ttdviewer/reference/clean_title_string.md)
over a representative set of tricky titles and returns a data frame
comparing the original and cleaned versions.
...
A data frame with columns `Original` and `Cleaned`.
